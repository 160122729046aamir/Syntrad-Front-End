          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="md:w-1/2 mb-6 md:mb-0">
              ...
              <p className="text-lg text-gray-400 mb-4">
                Our expert technicians provide repair solutions for a wide range
                of electronic devices, restoring functionality and extending the
                life of your equipment.
              </p>
              <p className="text-lg text-white">
                <b>
                  🛠 Certified Technicians | 💡 Honest Diagnostics | 📦 Warranty
                  Available
                </b>
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-gradient-to-br from-black/40 to-red-900/30 border border-red-700/30 rounded-2xl p-6 shadow-xl hover:shadow-red-600/40 transition transform hover:scale-105">
              ...
              <p className="text-gray-300 text-base sm:text-lg">
                ...
                diagnostic. We'll identify the issue and provide a clear repair
            ...
            <div className="bg-gradient-to-br from-black/40 to-red-900/30 border border-red-700/30 rounded-2xl p-6 shadow-xl hover:shadow-red-600/40 transition transform hover:scale-105">
              ...
              <p className="text-gray-300 text-base sm:text-lg">
                Convenient pickup and delivery options are available for home or
                business clients in our service area. Save time and avoid the
                hassle.
              </p>
            </div>
          </div>
