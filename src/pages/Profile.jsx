...
const Profile = () => {
    ...
    const fetchAppointments = async () => {
      try {
        ...
        if (response.data && response.data.appointments) {
          ...
          // Count statuses
          const statusCounts = response.data.appointments.reduce(
            (acc, appt) => {
  ...
  return (
    <>
      <Helmet>
        <title>Profile Settings | Syntrad</title>
        <meta
          name="description"
          content="Manage your profile, update your password, and view your appointments and orders on Syntrad."
        />
        <meta
          name="keywords"
          content="profile settings, Syntrad, user dashboard, manage account, appointments, orders"
        />
        <meta name="author" content="Syntrad Team" />
        <meta name="robots" content="index, follow" />

        {/* Open Graph for social sharing */}
        <meta property="og:title" content="Profile Settings | Syntrad" />
        <meta
          property="og:description"
          content="Update your user profile and track appointments and orders easily."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://syntrad.com/profile" />
        <meta
          property="og:image"
          content="https://syntrad.com/og-profile.jpg"
        />

        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Profile Settings | Syntrad" />
        <meta
          name="twitter:description"
          content="Manage your Syntrad profile, view order history and appointments."
        />
        <meta
          name="twitter:image"
          content="https://syntrad.com/og-profile.jpg"
