          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="md:w-1/2 mb-6 md:mb-0">
              ...
              <p className="text-lg text-gray-400 mb-4">
                With decades of horological expertise, we restore the precision,
                elegance, and function of vintage and antique timepieces. From
                Grandfather clocks to bracket clocks, our care is second to
                none. We also repair and service modern long case and short case
                clocks, blending traditional techniques with modern precision.
              </p>
