...
const Cart = () => {
  ...
  if (cartItems.length === 0) {
    return (
      <>
        <Helmet>
          <title>Your Cart | Syntrad Shop</title>
          <meta
            name="description"
            content="Review the items in your shopping cart at Syntrad. Modify quantities, remove items, and proceed to checkout with ease."
          />
          <meta
            name="keywords"
            content="repair service card, Syntrad service card, coffee machine service card, smart home repair card, gym equipment service card, Syntrad card benefits, Kaz moorjani"
          />

          <meta name="robots" content="noindex, nofollow" />
          <meta property="og:title" content="Your Cart | Syntrad" />
          <meta
            property="og:description"
            content="Manage your cart and get ready to complete your purchase on Syntrad."
          />
          <meta name="author" content="Kaz Moorjani" />
          <meta property="og:type" content="website" />
          <meta property="og:url" content="https://www.syntrad.com/cart" />
          <meta name="twitter:card" content="summary" />
          <meta name="twitter:title" content="Your Cart | Syntrad Shop" />
          <meta
            name="twitter:description"
            content="Easily manage your shopping cart and proceed to checkout."
          />
        </Helmet>
